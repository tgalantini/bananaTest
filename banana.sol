...
contract Banana is ERC1155, Ownable {
    ...
    address SuperBanana;
    address nftees = 0x8F3819b281012fBa163c57100d5d819798FE12f6;
    NFTees private immutable SC;
    ...
    function mint(uint256 amount, uint256 NfTeesId) public payable {
        ...
        require(SC.ownerOf(NfTeesId) == msg.sender, "Must be Owner of OG collection to mint");
        require(msg.value == amount * bananaPrice, "Invalid funds provided");
        require(AlreadyClaimed[NfTeesId] < 2 , "Token already claimed");
        _minted += amount;
        AlreadyClaimed[NfTeesId] += AlreadyClaimed[NfTeesId];
